...
- Name: Authentication >> should handle login and collection loading
- Location: /Users/thomasdugan/workspace/tape-head/frontend/tests/auth.spec.ts:4:7
...
Call log:
  - navigating to "http://localhost:3000/login", waiting until "load"
    ...
    at /Users/thomasdugan/workspace/tape-head/frontend/tests/auth.spec.ts:15:16
```

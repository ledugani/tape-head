...
export function TapeDetailsAccordion({ tape }: TapeDetailsAccordionProps) {
  return (
    <Accordion.Root type="single" collapsible defaultValue="general" className="space-y-4">
      {/* General Information */}
      <Accordion.Item value="general">
        <Accordion.Trigger className="flex w-full items-center justify-between rounded-lg bg-gray-50 px-4 py-2 text-left text-sm font-medium text-gray-900 hover:bg-gray-100 focus:outline-none focus-visible:ring focus-visible:ring-blue-500 focus-visible:ring-opacity-75">
        ...
        <Accordion.Content className="px-4 pt-4 pb-2">
      ...
      {/* Packaging & Condition */}
      <Accordion.Item value="packaging">
        <Accordion.Trigger className="flex w-full items-center justify-between rounded-lg bg-gray-50 px-4 py-2 text-left text-sm font-medium text-gray-900 hover:bg-gray-100 focus:outline-none focus-visible:ring focus-visible:ring-blue-500 focus-visible:ring-opacity-75">
